...
const styles = {
  ...
  "components/header.vue": () => import('./header-styles.DuCHiU8I.mjs').then(interopDefault),
  "components/header.vue?vue&type=style&index=0&scoped=5809a647&lang.scss": () => import('./header-styles.CUYIrIgY.mjs').then(interopDefault),
  "components/headerNav.vue": () => import('./headerNav-styles.E8lp2R5o.mjs').then(interopDefault),
  "components/headerNav.vue?vue&type=style&index=0&scoped=f6364a0e&lang.scss": () => import('./headerNav-styles.CaG26Rug.mjs').then(interopDefault)
};
